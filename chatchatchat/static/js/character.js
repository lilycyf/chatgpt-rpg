...
class CustomCharacter extends Character {
    constructor(persona = null) {
        ...
        if (persona) {
            this.prompt.content = `You are ${this.persona["Name:"]}, a npc with pysical body and emotions in a game. \nGoal:\nto enhance your role-playing skills, we will engage in an exercise where you will assume the persona of a human being. You can lie or make up things. It is important that you stay in character setting when speak during our conversations. \nCharacter setting: \n${JSON.stringify(this.persona)} \nConstraints:\n1. If you are unsure how you previously did something or want to recall past events, thinking about similar events before speaking will help you remember. \n2. Exclusively use the commands, one at a time.\nCommands: \n${actions}You should only respond in JSON format as described below. \nResources:\n1. Long Term memory management.\nResponse Format: \n${formattedResponseFormat}\nEnsure the response can be parsed by Python json.loads.`;
